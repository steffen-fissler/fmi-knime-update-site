...
public class MeasureAberration implements Command {
        ...
        public void run() {
                ...
                Vector<ComparePair> pair = Matching.descriptorMatching(listOfSpotLists, 2, params, 1.0f); // what about the original coordinates? changed?
                ...
                ArrayList<InvertibleBoundable> modelList = Matching.globalOptimization(pair, 2, params); // this will modify the points inside pair!
